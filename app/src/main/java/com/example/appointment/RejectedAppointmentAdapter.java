...
public class RejectedAppointmentAdapter extends FirebaseRecyclerAdapter<CreateAppointmentData, RejectedAppointmentAdapter.myViewHolder> {

    public RejectedAppointmentAdapter(@NonNull FirebaseRecyclerOptions<CreateAppointmentData> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull RejectedAppointmentAdapter.myViewHolder holder, int position, @NonNull CreateAppointmentData model) {
    ...
    @NonNull
    @Override
    public RejectedAppointmentAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.confirmed_appointment_resource,parent,false);
        return new RejectedAppointmentAdapter.myViewHolder(view);
    }
